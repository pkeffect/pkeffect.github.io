...
### Install default python version as an alternative with priority 1
```
...
### Install python 3.11 as an alternative with priority 2
```
sudo alternatives --install /usr/bin/python python /usr/bin/python3.11 2
```

### Switch between versions in use
```
...
That's it! You now have Miniconda installed on Fedora and a Python 3.11.11 virtual environment that you can activate anytime you need it.